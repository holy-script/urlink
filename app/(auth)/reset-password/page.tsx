// app/reset-password/page.tsx (or pages/reset-password.tsx for older Next.js)
"use client";
        ...
        <div className="w-full max-w-lg">
          ...
          {success ? (
            <div className="text-center p-6 bg-green-50 rounded-lg">
              ...
              <Button
                className="mt-6 w-full bg-[#5e17eb] hover:bg-[#4e13c4] text-white py-3 rounded-lg font-medium transition-colors"
