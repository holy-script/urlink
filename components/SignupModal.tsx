    ...
    <>
      <Dialog>
        <DialogTrigger asChild>
          <Button className="mt-8 bg-[#42c97a] hover:bg-[#42c97a] text-white text-xl flex items-center gap-2 rounded-lg group transition-all duration-500 ease-in-out overflow-hidden hover:pr-10 relative text-wrap h-fit">
            ...
            <span className="flex items-center line-clamp-2">
              {t('form.cta')}
              <span
